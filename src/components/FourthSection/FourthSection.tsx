  ...
  return (
    <section className="fourth-section" id="mint">
      <div className="fourth-section-container wrapper">
        ...
        <p className="t1">
          Claim your first 100% common AtomHead for free or mint extra (with a
          chance for rarer AtomHeads) for 0.001ETH & be a part of something that
          matters!
        </p>
        ...
        <a href="http://atomheads.opshyk.click/" className="bottom-element1">
          <div className="aspratio-box">
            <div className="ratio-container">
              ...
              <div className="el-footer">Claim Atomhead</div>
              <div className="left-badge left-badge1">free</div>
        ...
        <a href="http://atomheads.opshyk.click/" className="bottom-element2">
          <div className="aspratio-box">
            <div className="ratio-container">
              ...
              <div className="el-footer">Mint Atomhead</div>
